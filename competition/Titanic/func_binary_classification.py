def learn(file_path, file_name, epoch_size, input_size, mid1_size, mid2_size, output_size=1):
    ...
    all_datas = df.iloc[0:, 2:].to_numpy().astype(np.float32)
    ...
    class mlp_net(nn.Module):
        def __init__(self):
            ...
            self.normalizer1 = nn.BatchNorm1d(mid1_size)
            self.normalizer2 = nn.BatchNorm1d(mid2_size)
...
learn("./train2.csv", "train2", 100, 11, 64, 128)
...
# DataLoaderの作成
data_loader = DataLoader(dataset=custom_dataset, batch_size=1000, shuffle=True)
...
torch.save(model.state_dict(), 'up_down_model_weight.pth')
model_scripted = torch.jit.script(model)
model_scripted.save('up_down_model_scripted.pth')
